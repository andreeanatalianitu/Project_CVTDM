...
confusionMatrix(pred_valid.nb, valid$Output, positive = "1")$byClass["Balanced Accuracy"]
confusionMatrix(pred_test.nb, test$Output,positive = "1")$byClass["Balanced Accuracy"]
...
confusionMatrix(as.factor(ifelse(pred_valid.log > 0.5, 1, 0)), valid$Output, positive = "1")$byClass["Balanced Accuracy"]
confusionMatrix(as.factor(ifelse(pred_test.log > 0.5, 1, 0)), test$Output, positive = "1")$byClass["Balanced Accuracy"]
...
for(i in 1:30) {
  ...
  metrics[i, 2] = confusionMatrix(knn, valid.st[,37], positive = "1")$byClass["Balanced Accuracy"]
